...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 101 ????? 00100 11", srai   , I, R(dest) = (sword_t)src1 >> imm ); //arit shift
