...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw?  , R, R(dest) = SEXT( BITS(src1,31,0), 32)>>BITS(src2,4,0) );
