...
void Vsw___024root__traceInitSub0(Vsw___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+1,"sw clk", false,-1);
        tracep->declBit(c+2,"sw rst", false,-1);
        tracep->declBit(c+3,"sw a", false,-1);
        tracep->declBit(c+4,"sw b", false,-1);
        tracep->declBit(c+5,"sw f", false,-1);
    }
}
...
void Vsw___024root__traceFullSub0(Vsw___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+4,(vlSelf->b));
