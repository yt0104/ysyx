...
void Vtop___024root__traceInitSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+95,"rst_n", false,-1);
        tracep->declBus(c+96,"inst", false,-1, 31,0);
        tracep->declQuad(c+97,"pc", false,-1, 63,0);
        tracep->declBit(c+94,"top clk", false,-1);
        tracep->declBit(c+95,"top rst_n", false,-1);
        tracep->declBus(c+96,"top inst", false,-1, 31,0);
        tracep->declQuad(c+97,"top pc", false,-1, 63,0);
        tracep->declBit(c+76,"top exit_flag", false,-1);
        tracep->declBit(c+77,"top halt_ret", false,-1);
        tracep->declBus(c+1,"top cpu", false,-1, 31,0);
        tracep->declQuad(c+78,"top npc", false,-1, 63,0);
        ...
        tracep->declBus(c+96,"top u_IDU inst", false,-1, 31,0);
        tracep->declBus(c+71,"top u_IDU rd", false,-1, 4,0);
        ...
        tracep->declBit(c+94,"top u_EXU clk", false,-1);
        tracep->declBit(c+95,"top u_EXU rst_n", false,-1);
        tracep->declBus(c+71,"top u_EXU rd", false,-1, 4,0);
        ...
        tracep->declQuad(c+97,"top u_EXU pc", false,-1, 63,0);
        tracep->declQuad(c+78,"top u_EXU npc", false,-1, 63,0);
        tracep->declBit(c+76,"top u_EXU exit_flag", false,-1);
        tracep->declBit(c+77,"top u_EXU halt_ret", false,-1);
        tracep->declQuad(c+72,"top u_EXU src1", false,-1, 63,0);
        tracep->declQuad(c+74,"top u_EXU src2", false,-1, 63,0);
        tracep->declQuad(c+80,"top u_EXU dest", false,-1, 63,0);
        tracep->declBit(c+82,"top u_EXU wenR", false,-1);
        tracep->declQuad(c+83,"top u_EXU rdata", false,-1, 63,0);
        tracep->declQuad(c+85,"top u_EXU raddr", false,-1, 63,0);
        tracep->declQuad(c+87,"top u_EXU waddr", false,-1, 63,0);
        tracep->declQuad(c+89,"top u_EXU wdata", false,-1, 63,0);
        tracep->declBus(c+91,"top u_EXU wmask", false,-1, 7,0);
        tracep->declQuad(c+92,"top u_EXU temp", false,-1, 63,0);
        tracep->declBus(c+99,"top u_EXU u_reg ADDR_WIDTH", false,-1, 31,0);
        tracep->declBus(c+100,"top u_EXU u_reg DATA_WIDTH", false,-1, 31,0);
        tracep->declBit(c+94,"top u_EXU u_reg clk", false,-1);
        tracep->declQuad(c+72,"top u_EXU u_reg rdata1", false,-1, 63,0);
        tracep->declBus(c+2,"top u_EXU u_reg raddr1", false,-1, 4,0);
        tracep->declQuad(c+74,"top u_EXU u_reg rdata2", false,-1, 63,0);
        tracep->declBus(c+3,"top u_EXU u_reg raddr2", false,-1, 4,0);
        tracep->declQuad(c+80,"top u_EXU u_reg wdata", false,-1, 63,0);
        tracep->declBus(c+71,"top u_EXU u_reg waddr", false,-1, 4,0);
        tracep->declBit(c+82,"top u_EXU u_reg wen", false,-1);
...
void Vtop___024root__traceFullSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+71,(vlSelf->top__DOT__rd),5);
        tracep->fullQData(oldp+72,(vlSelf->top__DOT__u_EXU__DOT__src1),64);
        tracep->fullQData(oldp+74,(vlSelf->top__DOT__u_EXU__DOT__src2),64);
        tracep->fullBit(oldp+76,(vlSelf->top__DOT__exit_flag));
        tracep->fullBit(oldp+77,(vlSelf->top__DOT__halt_ret));
        tracep->fullQData(oldp+78,(vlSelf->top__DOT__npc),64);
        tracep->fullQData(oldp+80,(vlSelf->top__DOT__u_EXU__DOT__dest),64);
        tracep->fullBit(oldp+82,(vlSelf->top__DOT__u_EXU__DOT__wenR));
        tracep->fullQData(oldp+83,(vlSelf->top__DOT__u_EXU__DOT__rdata),64);
        tracep->fullQData(oldp+85,(vlSelf->top__DOT__u_EXU__DOT__raddr),64);
        tracep->fullQData(oldp+87,(vlSelf->top__DOT__u_EXU__DOT__waddr),64);
        tracep->fullQData(oldp+89,(vlSelf->top__DOT__u_EXU__DOT__wdata),64);
        tracep->fullCData(oldp+91,(vlSelf->top__DOT__u_EXU__DOT__wmask),8);
        tracep->fullQData(oldp+92,(vlSelf->top__DOT__u_EXU__DOT__temp),64);
        tracep->fullBit(oldp+94,(vlSelf->clk));
        tracep->fullBit(oldp+95,(vlSelf->rst_n));
        tracep->fullIData(oldp+96,(vlSelf->inst),32);
        tracep->fullQData(oldp+97,(vlSelf->pc),64);
