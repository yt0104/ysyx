...
VL_INLINE_OPT void Vtop___024root____Vdpiimwrap_top__DOT__u_EXU__DOT__step_and_dump_wave_TOP() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop___024root____Vdpiimwrap_top__DOT__u_EXU__DOT__step_and_dump_wave_TOP\n"); );
    // Body
    step_and_dump_wave();
}
